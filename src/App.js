...
export const BestSellingProduct = createContext();
function App() {
  const product_obj = [{
  ...
  const router = createBrowserRouter(createRoutesFromElements(
    <Route path='/' element={<WebLayout />}>
      ...
      <Route path='/bestseller' element={<BestSellersPage />}></Route>
    </Route>
  ))
  return (
    <BestSellingProduct.Provider value={product_obj}>
      <RouterProvider router={router}></RouterProvider>

    </BestSellingProduct.Provider>
  );
}
