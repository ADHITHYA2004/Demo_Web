    ...
    return (
        <div className='service pb-5'>
            <div className='mx-5 bg-white'>
                <div className='p-5 d-flex servicesCard'>
                    <div className='service-1 d-flex align-items-center gap-4 '>
                        ...
                        <div className='sevicetext-1'>
                            <div>
                                <p className='fs-5 fw-semibold'>Curb-side<br />Pickup</p>
                            </div>
                        </div>
                    </div>
                    <div className='service-2 d-flex align-items-center gap-4 '>
                            ...
                            <span>
                                ...
                                >
                                    <defs>
                                        <style>
                                            {`
            #comp-km3c06wy svg [data-color="1"] { fill: #000000; }
            #comp-km3c06wy svg [data-color="2"] { fill: #751FFF; }`}
                                        </style>
                                    </defs>
                                    <g>
                                        <path
                        ...
                        <div className='sevicetext-2'>
                            <div>
                                <p className='fs-5 fw-semibold'>Free shipping on<br />orders over $50</p>
                            </div>
                        </div>
                    </div>
                    <div className='service-3 d-flex align-items-center gap-4'>
                        ...
                        <div className='sevicetext-3'>
                            <div>
                                <p className='fs-5 fw-semibold'>Low prices<br />guaranteed</p>
                            </div>
                        </div>
                    </div>
                    <div className='service-4 d-flex align-items-center gap-4'>
                        <div className='icon-1'>
                            <span>
                                <svg
                                    preserveAspectRatio="xMidYMid meet"
                        ...
                        <div className='sevicetext-4'>
                            <div>
                                <p className='fs-5 fw-semibold'>Available to<br />you 24/7</p>
                            </div>
                        </div>
                    </div>
